          ...
          <Widget
            header={
              <div className={classes.title}>
                <Typography variant='h5'>General Metrics</Typography>
              </div>
            }
          ...
          >
            <div className={classes.subTitleContainer}>
              <Grid container item alignItems={'center'}>
                <Grid item xs={6}>
                  ...
                  <Typography size='md'>{metrics.total || 0}</Typography>
                </Grid>
              </Grid>
            </div>
            <Grid
            ...
            >
              <Grid item xs={3}>
                ...
                <Typography size='md'>{metrics.draft || 0}</Typography>
              </Grid>
              <Grid item xs={3}>
                <Typography color='text' colorBrightness='secondary' noWrap>
                  Funding
                </Typography>
                <Typography size='md'>{metrics.funding || 0}</Typography>
              </Grid>
              <Grid item xs={3}>
                <Typography color='text' colorBrightness='secondary' noWrap>
                  In Progress
                </Typography>
                <Typography size='md'>{metrics.inProgress || 0}</Typography>
              </Grid>
              <Grid item xs={3}>
                <Typography color='text' colorBrightness='secondary' noWrap>
                  Completed
                </Typography>
                <Typography size='md'>{metrics.completed || 0}</Typography>
              </Grid>
            </Grid>
          </Widget>
        </Grid>
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <Widget
              header={
                <div className={classes.title}>
                  <Typography variant='h5'>Filter By ID</Typography>
                </div>
              }
              bodyClass={classes.fullHeightBody}
              className={classes.card}
        ...
        <Grid container spacing={2}>
          <Grid item xs={6}>
            <Widget
              header={
                <div className={classes.title}>
                  <Typography variant='h5'>Specific Metrics</Typography>
                  <Select
                    value={dateVariation}
              ...
              <div className={classes.bottomStatsContainer}>
                <div className={classnames(classes.statCell)}>
                  <Grid container alignItems='center'>
                    ...
                    <ProfitSection
                      value={metricsEvent.create.difference}
                      classes={classes}
                      increase={metricsEvent.create.profit}
                    />
                ...
                <div className={classes.statCell}>
                  <Grid container alignItems='center'>
                    ...
                    <ProfitSection
                      value={metricsEvent.publish.difference}
                      classes={classes}
                      increase={metricsEvent.publish.profit}
                    />
                    <Typography variant='h6'>)</Typography>
                  </Grid>
                  <Typography
